        ...
        if (uniqueResult != null) {
            ...
            if (FLAG_TXT_VALIDATE == false) {
                ...
                try {
                    ...
                    // ClearTXT();
                    //newInvoiceArsh.comboCustomer.setSelectedItem(ct);
                   new newInvoiceArsh().comboCustomer.setSelectedItem(name + "-" + contac);

                    // new newInvoiceArsh().comboCustomer.sette(name+"-"+contac);
//                    new newInvoiceArsh().comboFilter2(name + "-" + contac);
//                    new newInvoiceArsh().comboFilter2DN(name + "-" + contac);
//                    System.out.println(name + "-" + contac);

                    new newInvoiceArsh().cust.put(contac, ct.getIdCustomer());
