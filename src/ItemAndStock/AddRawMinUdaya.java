 ...
 * @author oditha
 */
public class AddRawMinUdaya extends javax.swing.JFrame {

    /**
     * Creates new form AddRawMinUdaya
     */
    static boolean maximized = true;

    public AddRawMinUdaya() {
        initComponents();
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                if (jTable1.getValueAt(i, 3) != null) {
                    ...
                    rawItemInfo.setRawItems(rawItems);
                    rawItemInfo.setMinQty(jTable1.getValueAt(i, 3).toString());
    ...
    private void loadTable() {
        ...
        try {
            ...
            createCriteria.add(Restrictions.eq("isRow", "YES"));
            ...
            for (RawItems rawItems : list) {
                dtm.addRow(new Object[]{rawItems.getIdRawItems(), rawItems.getRawItemsCode(), rawItems.getItemName()});
    ...
    private void maximizeWindow() {
        ...
        if (maximized) {
            ...
            AddRawMinUdaya.this.setExtendedState(JFrame.MAXIMIZED_BOTH);
            GraphicsEnvironment gv = GraphicsEnvironment.getLocalGraphicsEnvironment();
            AddRawMinUdaya.this.setMaximizedBounds(gv.getMaximumWindowBounds());
            maximized = true;
        } else {
